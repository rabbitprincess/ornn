...
func (t *T_DB_RDS__vendor__mysql) get_sql__create_table(_pc_db *db.C_DB_conn) (arrs_sql__create_table []string, err error) {
	// db 안 모든 테이블 이름을 가져옴
...
func (t *T_DB_RDS__vendor__mysql) get_table_name__all(_pc_db *db.C_DB_conn) (arrs_table_name []string, err error) {
